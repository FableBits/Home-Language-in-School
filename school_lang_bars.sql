-- The table "wide_2026.csv" is from UNESCO's 'World Inequality Database on Education'
-- It is used to create the interactive bar chart the shows the difference in learning assessment performance
-- between the students who speak the school language at home and those who don't

SELECT * FROM `wide_2026.csv`;
